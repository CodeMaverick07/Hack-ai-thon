  ...
  return (
    <div className="h-screen mb-52 sm:mb-0" id="prize">
      ...
      <div className="flex flex-wrap pt-20 bg-[#11161F] justify-center sm:gap-24 gap-10">
        ...
        <div className="rounded-[100%] md:rounded-[100%] flex flex-col bg-zinc-950 p-8 md:p-16  shadow-2xl shadow-slate-600 text-center align-middle font-ai">
          <h1 className="text-white  text-5xl md:text-4xl font-prize self-center">
            certificates
          </h1>
          <h2 className="text-2xl  text-white self-center mt-5">for</h2>
